...
parser.add_argument('--iter', type=int, default=32, help='iteration of laplace equation')
parser.add_argument('--last', type=int, default=4, help='number of mask')

# model configuration
parser.add_argument('--model', '-m', type=str, default='chanVese', help='choose which model is going to use')
...
class main:
    ...
    def modelCall(self):
        ...
        if args.model == 'chanVese': 
            self.model = chanVese(args, self.train_loader, self.val_loader)
        else:
